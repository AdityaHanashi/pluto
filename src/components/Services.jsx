      ...
      <div className="w-full max-w-[98%] xl:max-w-[1600px] mx-auto px-4 md:px-8 relative z-10">
        ...
        {tab !== 'design' ? (
          ...
          <div className="flex flex-col gap-8 w-full max-w-[1400px] mx-auto pt-4">
            ...
            <div className="flex flex-wrap justify-center gap-4 mt-12 mb-8 glass rounded-3xl p-3 sm:p-4 border border-white/10 w-fit mx-auto bg-[#07070e]/80 shadow-2xl relative z-20">
              {[
